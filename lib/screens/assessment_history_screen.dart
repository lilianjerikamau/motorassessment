...
class AssesssmentHistoryScreen extends StatefulWidget {
  ...
  _AssesssmentHistoryScreenState createState() =>
      _AssesssmentHistoryScreenState();
}

class _AssesssmentHistoryScreenState extends State<AssesssmentHistoryScreen> {
        ...
        onPressed: () async {
          if (_formkey.currentState!.validate()) {
            ...
            HttpClientResponse response = await Config.getRequestObject(
                baseUrl +
                    'valuation/assessmenthistory/$_userid?from=$fromDate&to=$toDate',
                Config.get,
                dialog: _dialog);
            if (response != null) {
              response
